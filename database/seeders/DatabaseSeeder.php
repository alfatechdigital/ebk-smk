    ...
    public function run(): void
    {
        ...
        $svcData = [
            [
                ...
                'description' => "Masalah yang berkaitan dengan diri sendiri, seperti perasaan, emosi, kepercayaan diri, atau kondisi di lingkungan keluarga.",
                'icon' => 'fa-user',
                'color' => '#0d7c66',
                'is_active' => true,
            ],
            [
                ...
                'description' => "Masalah dalam hubungan dengan orang lain, seperti pertemanan, komunikasi, konflik, atau perundungan (bullying).",
                'icon' => 'fa-users',
                'color' => '#c8923a',
                'is_active' => true,
            ],
            [
                ...
                'description' => "Konsultasi mengenai rencana masa depan, seperti memilih jurusan, menentukan cita-cita, atau melanjutkan pendidikan.",
            ...
            [
                ...
                'description' => "Kesulitan yang berkaitan dengan proses belajar, seperti memahami pelajaran, motivasi belajar, atau mengatur waktu.",
                'icon' => 'fa-book-open',
                'color' => '#7c5cbf',
                'is_active' => true,
            ],
        ...
        // Admin
        User::create(['name' => 'Ahmad Fauzi', 'email' => 'admin@ebk.id', 'password' => $password, 'role' => 'admin', 'jenis_kelamin' => 'L', 'no_hp' => '08111222333']);

        // Guru BK 1
        $guruUser1 = User::create(['name' => 'Hendra Kurniawan, S.Pd', 'email' => 'guru@ebk.id', 'password' => $password, 'role' => 'guru', 'jenis_kelamin' => 'L', 'no_hp' => '081234567890']);
        ...
        // Guru BK 2
        $guruUser2 = User::create(['name' => 'Ratna Dewi, S.Psi', 'email' => 'guru2@ebk.id', 'password' => $password, 'role' => 'guru', 'jenis_kelamin' => 'P', 'no_hp' => '081234567891']);
        ...
        // Siswa 1 - Rafi
        $siswaUser1 = User::create(['name' => 'Rafi Ahmad', 'email' => 'siswa@ebk.id', 'password' => $password, 'role' => 'siswa', 'jenis_kelamin' => 'L', 'no_hp' => '08122334455']);
        $student1 = Student::create(['user_id' => $siswaUser1->id, 'class_id' => $classes[4]->id, 'nis' => '2024003']); // XI IPA 2

        // Siswa 2 - Siti
        $siswaUser2 = User::create(['name' => 'Siti Rahayu', 'email' => 'siti@ebk.id', 'password' => $password, 'role' => 'siswa', 'jenis_kelamin' => 'P', 'no_hp' => '08133445566']);
        $student2 = Student::create(['user_id' => $siswaUser2->id, 'class_id' => $classes[3]->id, 'nis' => '2024001']); // XI IPA 1

        // Siswa 3 - Budi
        $siswaUser3 = User::create(['name' => 'Budi Santoso', 'email' => 'budi@ebk.id', 'password' => $password, 'role' => 'siswa', 'jenis_kelamin' => 'L', 'no_hp' => '08144556677']);
        $student3 = Student::create(['user_id' => $siswaUser3->id, 'class_id' => $classes[2]->id, 'nis' => '2024002']); // X IPS 2

        // Siswa 4 - Dewi
        $siswaUser4 = User::create(['name' => 'Dewi Safitri', 'email' => 'dewi@ebk.id', 'password' => $password, 'role' => 'siswa', 'jenis_kelamin' => 'P', 'no_hp' => '08155667788']);
        $student4 = Student::create(['user_id' => $siswaUser4->id, 'class_id' => $classes[3]->id, 'nis' => '2024004']);

        // Siswa 5 - Andi
        $siswaUser5 = User::create(['name' => 'Andi Rahmat', 'email' => 'andi@ebk.id', 'password' => $password, 'role' => 'siswa', 'jenis_kelamin' => 'L', 'no_hp' => '08166778899']);
        $student5 = Student::create(['user_id' => $siswaUser5->id, 'class_id' => $classes[0]->id, 'nis' => '2024005']);

        // Ticket 1 - Rafi (menunggu)
        $t1 = Ticket::create([
            'code' => '#TK-2024-001', 'student_id' => $student1->id, 'class_id' => $student1->class_id, 'service_id' => $services[0]->id,
        ...
        $t2 = Ticket::create([
            'code' => '#TK-2024-002', 'student_id' => $student4->id, 'class_id' => $student4->class_id, 'service_id' => $services[2]->id,
        ...
        $t3 = Ticket::create([
            'code' => '#TK-2024-003', 'student_id' => $student2->id, 'class_id' => $student2->class_id, 'service_id' => $services[1]->id,
        ...
        Ticket::create([
            'code' => '#TK-2024-004', 'student_id' => $student3->id, 'class_id' => $student3->class_id, 'service_id' => $services[3]->id,
        ...
        Ticket::create([
            'code' => '#TK-2024-005', 'student_id' => $student5->id, 'class_id' => $student5->class_id, 'service_id' => $services[0]->id,
