    ...
    <style>
        ...
        @media (max-width: 768px) {
            #login-screen {
                ...
                /* Mengikuti warna dasar tema ebk.css */
            ...
            .login-form-panel {
                width: 100% !important;
                max-width: 440px;
                /* Batasi lebar maksimal di HP agar tidak terlalu melar */
                padding: 32px 24px !important;
                border-radius: var(--radius);
                /* Membunderkan sudut panel di mobile */
            ...
            .login-hint {
                ...
                /* Mencegah teks email panjang memotong layar */
            }
        }
    ...
    <div id="login-screen">
        ...
        <div class="login-art">
            ...
            <div class="login-logo"
                style="margin-bottom:20px; width:72px; height:72px; border-radius:20px; background: var(--teal-light); display: flex; align-items: center; justify-content: center;">
